/**
 * Weapon Detection Screen with dynamic theme
 */
    ...
    return (
        ...
        >
            ...
            <View style={styles.header}>
                <View style={[styles.headerGlow, { backgroundColor: `${colors.secondary}30` }]} />
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Weapon Detection</Text>
                <Text style={[styles.headerDescription, { color: colors.textMuted }]}>
                    Advanced AI to detect weapons and firearms in images
                </Text>
            </View>
            ...
            {currentImage && currentResult && currentResult.detections.length > 0 && (
                <View style={[styles.imageWithOverlay, { borderColor: `${colors.secondary}30` }]}>
                    <Image
            ...
            {currentImage && (
                <View style={styles.section}>
                    ...
                    >
                        {isLoading ? '⏳ Scanning...' : '🎯 Detect Weapons'}
                    </Button>
                </View>
            )}

            {/* Loading State */}
            {isLoading && <LoadingSpinner message="Scanning for weapons..." />}
